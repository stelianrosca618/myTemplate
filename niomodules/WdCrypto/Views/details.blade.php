                ...
                <div class="nk-pps-data">
                    <ul class="nk-olist">
                        <li class="nk-olist-item">
                            <div class="label lead-text">{{ __('Withdraw Account (:name)', ['name' => get_currency(data_get($details, 'tnx_currency'), 'name'). ' Wallet']) }}</div>
                            <div class="data"><span class="method"><em class="icon ni ni-wallet-fill"></em> <span class="ellipsis w-max-225px">{{ str_compact(data_get($transaction, 'meta.pay_meta.wallet'), '..', 6) }}</span></span></div>
                        </li>
