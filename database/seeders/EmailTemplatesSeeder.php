    ...
    public function run()
    {
        $templates = [
            'users-confirm-email' => [
                ...
                'params' => ["regards" => "on"],
                'subject' => '[[verify_code]] - Verify Your Email Address - [[site_name]]',
                'greeting' => 'Welcome [[user_name]]!',
                'content' => "Thank you for registering on our platform. You're almost ready to start.\n\nUse the below code to confirm your email address and activate your account.",
                'shortcut' => '[[verify_code]]',
            ],
            ...
            'users-welcome-email' => [
                ...
                'content' => "Thanks for joining our platform! \n\nAs a member of our platform, you can mange your account, deposit, invest and withdraw. \n\nFind out more about in - [[site_url]]",
                'shortcut' => '',
            ],
            ...
            'user-registration-admin' => [
                'name' => 'Welcome Email for Add User',
