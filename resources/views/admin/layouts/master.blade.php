...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/'.$style.'.css?ver=140') }}">
@if(sys_settings('ui_theme_skin_admin', 'default') != 'default')
    <link rel="stylesheet" href="{{ asset('assets/css/skins/theme-'.sys_settings('ui_theme_skin_admin').'.css?ver=140') }}">
@endif
</head>
...
<div class="nk-app-root">
    ...
    <div class="nk-main ">
        ...
        <div class="nk-wrap @yield('has-content-sidebar')">
            ...
            <div class="nk-content @yield('fullsceen-class')">
                <div class="container-fluid @yield('fullsceen-class')">
...
<script src="{{ asset('assets/js/bundle.js?ver=140') }}"></script>
<script src="{{ asset('assets/js/app.js?ver=140') }}"></script>
<script src="{{ asset('assets/js/app.admin.js?ver=140') }}"></script>
@stack('scripts')
