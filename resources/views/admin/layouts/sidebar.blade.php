                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub{{ is_route('admin.users*') ? ' active' : '' }}">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item{{ (is_route('admin.users.manage.groups')) ? ' active' : '' }}">
                                <a href="{{ route('admin.users.manage.groups') }}" class="nk-menu-link"><span class="nk-menu-text">{{ __('Manage Groups') }}</span></a>
                            </li>
                        </ul>
                    </li>
                    @if(module_exist('BasicKYC', 'mod') && has_route('admin.kyc.list'))
                    <li class="nk-menu-item has-sub{{ is_route('admin.kyc*') ? ' active' : '' }}">
                        <a href="{{ route('admin.kyc.list', ['state' => 'process']) }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-check-circle-cut"></em></span>
                            <span class="nk-menu-text">{{ __('Verification Center') }}</span>
                        </a>
                    </li>
                    @endif
                    @if(module_exist('SupportTicket', 'addon') && has_route('admin.ticket.list'))
                    <li class="nk-menu-item{{ is_route('admin.ticket*') ? ' active' : '' }}">
                        <a href="{{ route('admin.ticket.list', ['type' => 'inbox']) }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-help-alt"></em></span>
                            <span class="nk-menu-text">{{ __('Support Center') }}</span>
                        </a>
                    </li>
                    @endif
                    <li class="nk-menu-heading">
