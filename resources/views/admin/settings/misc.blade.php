                ...
                <form action="{{ route('admin.save.app.settings') }}" class="form-settings" method="POST">
                    ...
                    <div class="form-sets gy-3 wide-md">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="form-control-wrap w-max-250px">
                                        <select name="logout_redirect" id="logout-rediction-page" class="form-select">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="form-label" for="invest-earn-page">{{ __('Invest & Earn Button Link') }}</label>
                                    <span class="form-note">
                                        {!! __('Select the page you would like to link the button.') !!}
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="form-control-wrap w-max-250px">
                                        <select name="invest_earn_redirect" id="invest-earn-page" class="form-select">
                                            <option value="default"{{ (sys_settings('invest_earn_redirect', 'default') == 'default') ? ' selected' : '' }}>
                                                {{ __(':name Page', ['name' => __('Invest')]) }}
                                            </option>
                                            <option value="plan"{{ (sys_settings('invest_earn_redirect') == 'plan') ? ' selected' : '' }}>
                                                {{ __(':name Page', ['name' => __('Our Plan')]) }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
