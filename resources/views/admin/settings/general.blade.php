                ...
                <form action="{{ route('admin.save.app.settings') }}" class="form-settings" method="POST" autocomplete="off">
                    <div class="form-sets gy-3 wide-md">
                        <div class="row g-3 align-center">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="form-label" for="default-lang-adminend">{{ __('Default Language') }}</label>
                                ...
                                <ul class="custom-control-group g-3 align-center flex-wrap">
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="reg-enable" value="enable" name="signup_allow"
                                                {{ sys_settings('signup_allow', 'enable') == 'enable' ? ' checked' : '' }}>
                                            <label class="custom-control-label" for="reg-enable">{{ __('Enable') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="signup_allow" value="invite" id="reg-invite"
                                                {{ sys_settings('signup_allow', 'enable') == 'invite' ? ' checked' : '' }}>
                                            <label class="custom-control-label" for="reg-invite">{{ __('Invite Only') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="signup_allow" value="disable" id="reg-disable"
                                                {{ sys_settings('signup_allow', 'enable') == 'disable' ? ' checked' : '' }}>
                                            <label class="custom-control-label" for="reg-disable">{{ __('Disable') }}</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input class="switch-option-value" type="hidden" name="email_verification" value="{{ sys_settings('email_verification') ?? 'on' }}">
                                        <input id="email-verify-option" type="checkbox" class="custom-control-input switch-option" data-switch="on"{!! sys_settings('email_verification', 'on') == 'on' ? ' checked=""' : '' !!}>
                                        <label for="email-verify-option" class="custom-control-label">{{ __('Enable') }}</label>
                                    </div>
                                    <span class="form-note mt-1"><em class="text-danger">{{ __("User still need to verify email address If disable, but user can verify after login into dashboard.") }}</em></span>
                                </div>
                            </div>
                        </div>
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input class="switch-option-value" type="hidden" name="referral_system" value="{{ sys_settings('referral_system') ?? 'no' }}">
                                        <input id="enable-referral-system" type="checkbox" class="custom-control-input switch-option" data-switch="yes"{!! sys_settings('referral_system', 'no') == 'yes' ? ' checked=""' : '' !!}>
                        ...
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-md-7">
                                <ul class="custom-control-group g-3 align-center flex-wrap flex-sm-nowrap">
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="referral_show_info" value="hide" 
                                    ...
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="referral_show_info" value="invite" 
                                    ...
                                    <li>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" name="referral_show_info" value="uname" 
                    ...
                    <div class="form-sets gy-3 wide-md">
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input class="switch-option-value" type="hidden" name="maintenance_mode" value="{{ sys_settings('maintenance_mode') ?? 'off' }}">
                                        <input id="maintenance-option" type="checkbox" class="custom-control-input switch-option" data-switch="on"{!! sys_settings('maintenance_mode', 'off') == 'on' ? ' checked=""' : '' !!}>
                                        <label for="maintenance-option" class="custom-control-label">{{ __('Offline') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-3 align-start">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <textarea class="form-control" name="maintenance_notice">{{ sys_settings('maintenance_notice') }}</textarea>
                                    </div>
                                    <div class="form-note">
                                        <span>{{ __('Admin Login on maintenance mode:') }} <strong class="text-primary">{{ url('/admin/login') }}</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
