                ...
                <div class="nk-block-head-content">
                    <ul class="nk-block-tools gx-1">
                        ...
                        @if($invest->status == InvestmentStatus::PENDING)
                            ...
                            <li class="order-md-last"><a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#approve-investment"><em class="icon ni ni-check"></em> <span>{{ __('Approve') }}</span> </a></li>
                            <li class="order-md-last"><a href="javascript:void(0)" class="btn btn-danger actnivs" data-confirm="yes" data-reload="yes" data-action="cancelled" data-uid="{{ the_hash($invest->id) }}"><em class="icon ni ni-cross"></em> <span>{{ __('Cancel') }}</span> </a></li>
                        @endif
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="link-list-opt no-bdr">
                                        ...
                                        <li>
                                        <a href="javascript:void(0)" data-action="plan" data-backdrop="static" class="actn-psivs {{ (is_locked('plan')) ? ' disabled' : '' }}">
                                            <em class="icon ni ni-invest"></em><span>{{ __('Approve the profits') }}</span></a>
                                        </li>
                                        @endif
                                        @if($invest->remaining_term === 0)
                                        <li>
                                        <a href="javascript:void(0)" class="actnivs" data-reload="yes" data-confirm="yes" data-action="complete" data-uid="{{ the_hash($invest->id) }}"><em class="icon ni ni-check-circle-cut"></em><span>{{__('Complete this plan')}}</span></a>
                                        </li>
                                        @endif
                                        <li>
                    ...
                    <tr>
                        ...
                        <td class="tb-col-paid tb-col-end">
                            ...
                            @elseif(($invest->payout_type === SchemePayout::TERM_BASIS) || ($invest->payout_type === SchemePayout::AFTER_MATURED && $invest->remaining_term === 0))
                                <a href="javascript:void(0)" class="btn btn-xs btn-round btn-icon btn-dim btn-outline-primary actnivs mr-n1" data-reload="yes" data-confirm="yes" data-action="profit" data-uid="{{ $profit->id }}"><em class="icon ni ni-check"></em></a>
                            @endif
                            </span>
                        </td>
                    </tr>
            ...
            <div class="modal-body modal-body-md">
                ...
                <form action="{{ route('admin.investment.plan.approve', ['id' => the_hash($invest->id)]) }}" method="POST" data-confirm="approved" class="form-validate is-alter">
                    ...
                    <ul class="align-center flex-wrap flex-sm-nowrap gx-1 gy-2">
                        <li>
                            <button type="button" class="btn btn-lg btn-primary actn-apivs">{{ __('Approve') }}</button>
                        </li>
                        <li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                ...
                <form action="{{ route('admin.investment.plan.cancel', ['id' => the_hash($invest->id)]) }}" method="POST" data-confirm="cancelled" class="form-validate is-alter">
                    ...
                    <ul class="align-center flex-wrap flex-sm-nowrap gx-1 gy-2">
                        <li>
                            <button type="button" class="btn btn-lg btn-danger actn-cpivs">{{ __('Cancel the Plan') }}</button>
                        </li>
                        <li>
...
@endpush
@else
    @if (view()->exists('ExtInvest::admin.invest.details'))
        @include('ExtInvest::admin.invest.details')
    @endif
@endif
