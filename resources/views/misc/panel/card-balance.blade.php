    ...
    <div class="card-inner">
        ...
        <div class="card-action d-md-none">
            <ul class="nk-block-tools g-3 flex-wrap flex-sm-nowrap">
                ...
                <li><a href="{{ (gss('invest_earn_redirect', 'default') == 'plan') ? route('user.investment.plans') : route('user.investment.invest') }}" class="btn btn-secondary"><span>{{ __('Invest & Earn') }}</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
