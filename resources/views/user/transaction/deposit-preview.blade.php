@php
    ...
    if (data_get($pm, 'slug') == 'paypal') {
        $paypal = app()->get('paypal');
        if (in_array($currency, $paypal->getNonDecimalCurrencies())) {
            $amount = round($amount);
            $payment = $paypal->updateSessionData();
        }
    }
@endphp
...
<div class="nk-pps-apps">
    ...
    <div class="nk-pps-field form-action text-center">
        <div class="nk-pps-action">
            <a href="#" class="btn btn-lg btn-block btn-primary" id="confim-py" data-url="{{ route('deposit.confirm') }}">
