<div class="nk-sidebar nk-sidebar-fat nk-sidebar-fixed {{ gui_mode(gui('user', 'sidebar')) }} x-{{ gui('user', 'sidebar') }}" data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        {{ site_branding('sidebar', ['panel' => 'user', 'size' => gss('logo_size', 'md'), 'class_link' => 'nk-sidebar-logo', 'custom_link' => logo_link('ud', 'raw')]) }}
            ...
            <div class="nk-sidebar-content">
                    ...
                    <ul class="user-account-data gy-1">
                        <li>
                            ...
                            <div class="user-account-value">
                                ...
                                @elseif($profit['percentage']<0) <span class="text-danger ml-2">{{
                                    abs($profit['percentage'])."%" }} <em class="icon ni ni-arrow-long-down"></em></span>
                                    @endif
                            </div>
                        </li>
                ...
                <div class="nk-sidebar-widget nk-sidebar-widget-full d-xl-none pt-0">
                    ...
                    <div class="nk-profile-content toggle-expand-content" data-content="sidebarProfile">
                        <div class="user-account-info between-center">
                            <div class="user-account-main">
                                <h6 class="overline-title-alt">{{ __(":Account Balance", ['account' =>
                                    w2n(AccType('main'))]) }}</h6>
                                <div class="user-balance">{{ account_balance(AccType('main')) }} <small class="currency">{{ base_currency() }}</small></div>
                                <div class="user-balance-alt">{{ account_balance(AccType('main'), 'alter') }} <span class="currency">{{ secondary_currency() }}</span></div>
                            </div>
                            ...
                            <li>
                                ...
                                <div class="user-account-value">
                                    ...
                                    <div class="user-account-value">
                                        ...
                                        @if($profit['percentage']>0)
                                        <span class="text-success ml-2">{{ abs($profit['percentage'])."%" }} <em class="icon ni ni-arrow-long-up"></em></span>
                                        @elseif($profit['percentage']<0) <span class="text-danger ml-2">{{ abs($profit['percentage'])."%" }} <em class="icon ni ni-arrow-long-down"></em></span>
                                            @endif
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="link-list">
                            ...
                            @if(module_exist('SupportTicket', 'addon') && has_route('user.ticket.list') && gss('ticket_feature_enable') == 'yes')
                            <li><a href="{{ route('user.ticket.list') }}"><em class="icon ni ni-help-alt"></em><span>{{__('Support Center') }}</span></a></li>
                            @endif
                ...
                <div class="nk-sidebar-footer">
                    <ul class="nk-menu nk-menu-footer">
                        @if(module_exist('SupportTicket', 'addon') && has_route('user.ticket.list') &&
                        gss('ticket_feature_enable') == 'yes' && gss('ticket_support_link') == 'yes')
                        <li class="nk-menu-item mr-2">
                            <a href="{{ route('account.profile') }}" class="nk-menu-link">
